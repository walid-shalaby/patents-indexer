...
@XmlType(name = "", propOrder = {
    "docPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims"
})
...
public class UsPatentApplication {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "sequence-list-doc", required = true, type = SequenceListDoc.class),
    ...
    protected List<Object> docPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims;
    ...
    /**
     * Gets the value of the docPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the docPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDocPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDocPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims() {
        if (docPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims == null) {
            docPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims = new ArrayList<Object>();
        }
        return this.docPageOrUsBibliographicDataApplicationOrAbstractOrDrawingsOrDescriptionOrSequenceListDocOrTableExternalDocOrUsChemistryOrUsMathOrClaims;
    }
